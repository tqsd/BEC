...
from bec.light.envelopes import ClassicalTwoPhotonDrive
from bec.light.envelopes import envelope_from_json
...
def build_drive_from_signal(signal: Dict[str, Any]) -> ClassicalTwoPhotonDrive:
    ...
    # CASE (B): flat spec (treat the whole dict as an envelope JSON)
    if "type" in signal:
