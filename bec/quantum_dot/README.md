...
- `dot.py` - Facade `QuantumDot` class. This class orchestrates everything:
  ...
  - builds Hamiltonians, decay rates, and collapes ops
  - exposes quantum dot and light-mode obesrvables
...
- `decay_model.py` - Computes the readiative rates (free space, Purcel) from energies, cavity and dipole.
...
- `metrics/` - Diagnostic/Analisys helpers
