...
from bec.quantum_dot.units import EnergyLike, as_eV
...
class EnergyStructure:
    ...
    def from_params(
        ...
        *,
        ...
        X1 = EX.to("eV") + 0.5 * d.to("eV")
        X2 = EX.to("eV") - 0.5 * d.to("eV")
        XX = 2.0 * EX.to("eV") - Eb.to("eV")
    ...
    def validate(self) -> None:
        ...
        if X1 <= 0 or X2 <= 0 or XX <= 0:
            raise ValueError(
                f"Energies must be > 0 eV: X1={
                    X1}, X2={X2}, XX={XX}"
            )
