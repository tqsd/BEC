...
class DriveReportData:
    ...
    t_peak_solver: float | None
    t_peak_phys_s: float | None
    E_env_peak_V_m: float | None
...
def compute_drive_report_data(
    ...
    *,
    ...
    t_peak_solver: float | None = None
    t_peak_phys_s: float | None = None
    E_peak: float | None = None
